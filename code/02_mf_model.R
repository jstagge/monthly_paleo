# *------------------------------------------------------------------
# | PROGRAM NAME: mf_model
# | FILE NAME: 02_mf_model.R
# | DATE: 09/15/2017
# | CREATED BY:  James Stagge         
# *----------------------------------------------------------------
# | PURPOSE:  This script runs the Monthly Fraction (MF) Model for the Bear and
# |				Logan Rivers. The method is detailed in Stagge et al. (2017), which     
