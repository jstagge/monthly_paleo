...
lag_fit <- perc_fit_lag(data=flow_obs, monthly_param, annual_param, data_name="observ_annual")
### Write to csv file
...
lag_fit <- perc_fit_lag(data=flow_obs, monthly_param, annual_param, data_name="annual_flow_rec_local_m3s")
### Write to csv file
...
lag_fit <- perc_fit_lag(data=flow_obs, monthly_param, annual_param, data_name="annual_flow_rec_region_m3s")
### Write to csv file
...
lag_fit <- perc_fit_lag(data=flow_obs, monthly_param, annual_param, data_name="annual_flow_rec_m3s")
### Write to csv file
...
ggsave(paste0(file.path(write_figures_path,"png/"), site_id, "_percent_lag_coef_", data_name,".png"), p, width=6, height=4, dpi=600)
ggsave(paste0(file.path(write_figures_path,"svg/"), site_id, "_percent_lag_coef_", data_name,".svg"), p, width=6, height=4)
ggsave(paste0(file.path(write_figures_path,"pdf/"), site_id, "_percent_lag_coef_", data_name,".pdf"), p, width=6, height=4)
