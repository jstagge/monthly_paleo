...
# *----------------------------------------------------------------
# | PURPOSE:  This script calculates Goodness of Fit (GOF) for all models in the
# |				project, including MF, AP, and APR models. It also plots
# | 			several GOF figures to evaluate the models.  
# |				 
# *------------------------------------------------------------------
# | DATA USED:               
# | Reconstruction models calculated in 02_mf_model.R and 04_ap_apr_model.R 
# |
# *------------------------------------------------------------------
# | COMMENTS:               
# |
