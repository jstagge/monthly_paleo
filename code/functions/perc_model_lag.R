...
perc_model_lag <- function(annual_rec, monthly_param, annual_param, norm_model, first_month_wy, data_name) {
	require(assertthat)
	...
	for (j in seq(1,12)) {
		...
		monthly_norm <- monthly_norm + norm_model_subset["annual_norm"] * monthly_subset$annual_norm
		monthly_norm <- monthly_norm + norm_model_subset["annual_norm_neg_1year"] * monthly_subset$annual_norm_neg_1year
		monthly_norm <- monthly_norm + norm_model_subset["annual_norm_pos_1year"] * monthly_subset$annual_norm_pos_1year
